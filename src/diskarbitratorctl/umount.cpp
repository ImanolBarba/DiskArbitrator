/***************************************************************************
 *   umount.cpp  --  This file is part of diskarbitratorctl.               *
 *                                                                         *
...
bool doUmount(int argc, char** argv) {
  cxxopts::Options options("diskarbitratorctl umount", "umount: Unmounts the specified disk");
  options.add_options()
